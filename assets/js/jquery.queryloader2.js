...
OverlayLoader.prototype.createOverlay = function () {
	...
	if (this.parent.options.percentage == true) {
		...
		this.percentageContainer = $("<div id='qLpercentage'></div>").text("00").css({ //update by omg
			height: "40px",
			width: "100px",
			position: "absolute",
			fontSize: "3em",
...
OverlayLoader.prototype.updatePercentage = function (percentage) {
	...
	//if (this.parent.options.percentage == true) {
	if (this.parent.options.percentage == true && Math.ceil(percentage) < 100) { //update by omg
		//this.percentageContainer.text(Math.ceil(percentage) + "%"); 
		this.percentageContainer.text(('0' + Math.ceil(percentage)).substr(-2,2)); //update by omg
	}
};
